...
# 2024/5/29
提交人： 刘乐
1. 更新初始页面，增加帮助按钮，点击后弹出帮助页面。详细介绍游戏规则。碰：Pung，杠：Kong，暗杠：Concealed Kong，庄家：Banker.
2. 待修改：初始界面调整开始单机游戏，联机，帮助页面。游戏操作的英文名称已统一，但是并未在各文件中修改。后续需要使用统一命名。
3. 注释待更新
...
- Player
2. 优化UI界面
3. 添加背景音乐和部分音效（碰，杠）吃的音效没有找到
@WZH
待修改：
- 胡牌后需要能让玩家知道自己的牌胡了，即先显示牌，在弹出胜利
- 联机中其他玩家需要可以看到其他家的不可操作牌堆

# 2024/6/4
提交人：王子恒

修改游戏判定：胡牌后需要能让玩家知道自己的牌胡了，即先显示牌，在弹出胜利
